...
<<<<<<< HEAD
ENV S3_EMAIL_DOMAINS_BUCKET 'StubBucket'
=======
ENV S3_PRODUCT_PAGE_DATA_BUCKET 'StubBucket'
ENV S3_ORGANISATION_NAMES_OBJECT_KEY 'StubKEY'
>>>>>>> master
ENV S3_EMAIL_DOMAINS_OBJECT_KEY 'StubKEY'
