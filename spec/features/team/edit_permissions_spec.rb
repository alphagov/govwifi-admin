  ...
  context "with the .can_manage_team permission" do
    context "when the user belongs to my organisation" do
      ...
      context "when there are are two or less admin users for an organisation" do
        context "when the user wants to edit permissions for an admin who has yet to confirm" do
          before do
        ...
        context "when the user wants to edit permissions for an admin who has confirmed" do
          before do
          ...
          it "shows the flash alert" do
            expect(page).to have_content("There is a problem\nYou must add another administrator before you can change permissions for #{invited_user_same_org.name}.")
          end
        end
      end
