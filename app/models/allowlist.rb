class Allowlist
  ...
  validate :validate_organisation_name, unless: proc { |allowlist|
    allowlist.organisation_name.blank?
  }
  validate :validate_email_domain, unless: proc { |allowlist| allowlist.email_domain.blank? }
