class SuperAdmin::Whitelists::EmailDomainsController < SuperAdminController
  ...
  def create
    ...
    if @authorised_email_domain.save
      ...
      redirect_to super_admin_whitelist_email_domains_path, notice: "#{@authorised_email_domain.name} authorised"
    else
      render :new
    end
  end
  ...
  def destroy
    ...
    redirect_to super_admin_whitelist_email_domains_path, notice: "#{authorised_email_domain.name} has been deleted"
  end
